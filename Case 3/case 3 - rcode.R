...
# Modellen er: y=α+β×x. 
# I denne modellen er temperatur den avhengige variabelen (y) som blir forklart av CO2, den uavhengig variabelen (x).
# Tolkning av β parameteret i denne modellen er; en 1 enhets endring i x fører til en β enhets endring i y.

# Du må nå huske hva som er enhetene dine. Tolk resultatet.
